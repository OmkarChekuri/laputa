...
// Laputa palette: teal primary (sky and sea), indigo secondary, amber tertiary.

import androidx.compose.ui.graphics.Color

val primaryLight = Color(0xFF00696F)
val onPrimaryLight = Color(0xFFFFFFFF)
val primaryContainerLight = Color(0xFFA6EFF4)
val onPrimaryContainerLight = Color(0xFF004F53)
val secondaryLight = Color(0xFF3949AB)
val onSecondaryLight = Color(0xFFFFFFFF)
val secondaryContainerLight = Color(0xFFDDE1FF)
val onSecondaryContainerLight = Color(0xFF26318A)
...
val inversePrimaryLight = Color(0xFF7FD6DC)
val surfaceDimLight = Color(0xFFD3DBE5)
val surfaceBrightLight = Color(0xFFFFFFFF)
val scrimLight = Color(0xFF000000)

val primaryDark = Color(0xFF7FD6DC)
val onPrimaryDark = Color(0xFF00373A)
val primaryContainerDark = Color(0xFF004F53)
val onPrimaryContainerDark = Color(0xFFA6EFF4)
val secondaryDark = Color(0xFFBAC3FF)
val onSecondaryDark = Color(0xFF0B1A73)
val secondaryContainerDark = Color(0xFF26318A)
val onSecondaryContainerDark = Color(0xFFDDE1FF)
val tertiaryDark = Color(0xFFF6BE48)
